    ...
    <section class="page home-page">
      ...
      <div class="metrics-grid" id="metrics-grid">
        ...
        <div class="metric-card">
          ...
          <div class="metric-info">
            <h3 class="counter-number" data-target="28">0</h3>
        ...
        <div class="metric-card">
          ...
          <div class="metric-info">
            <h3 class="counter-number" data-target="145">0</h3>
            <p>Aktif Üye</p>
          </div>
        </div>
      </div>
  ...
  if (ctxPie && pieContainer) {
    ...
    const renderPie = () => {
      ...
      pieChartInstance = new Chart(ctxPie, {
        type: 'doughnut',
        data: {
          labels: ['Yönetim Kurulu', 'Proje Komitesi', 'Pazarlama ve Sosyal Medya Komitesi', 'Sponsorluk ve Organizasyon Komitesi', 'Akademi Komitesi'],
          datasets: [{
            data: [10, 40, 25, 15, 30],
            backgroundColor: [
              '#f59e0b', // turuncu
